              ...
              >
                {group.symbols.map((symbol) => (
                  <button
                    ...
                    title={`Insert ${symbol}`}
                    className="flex h-7 w-7 items-center justify-center rounded text-sm text-[#1B1F23] hover:bg-[#fae8ff] hover:text-[#7E2D8E] transition-colors"
                  >
                    {symbol}
                  </button>
                ))}
