...
const TONE_CLASSES: Record<Tone, string> = {
  magenta: 'bg-gradient-to-r from-[#C04ACD] to-[#7E2D8E] text-white',
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(192,74,205,0.08) 0%, rgba(192,74,205,0.02) 60%, transparent 100%)',
        }}
      />
      <div
        aria-hidden
        ...
        style={{
          backgroundImage: 'radial-gradient(circle, #C04ACD 1px, transparent 1px)',
