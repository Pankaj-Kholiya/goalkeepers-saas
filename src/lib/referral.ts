...
export const REFERRAL_TIERS: ReferralTier[] = [
  ...
  { key: 'RECRUITER', label: 'Recruiter', min: 3, color: '#C04ACD', blurb: 'Brought in 3 classmates' },
  { key: 'AMBASSADOR', label: 'Ambassador', min: 5, color: '#F59E0B', blurb: 'Brought in 5 classmates' },
  { key: 'CAMPUS_LEGEND', label: 'Campus Legend', min: 10, color: '#7E2D8E', blurb: 'Brought in 10 classmates' },
]
