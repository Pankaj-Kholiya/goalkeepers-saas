            ...
            <button
              ...
              className={
                selectionKind === 'pinned'
                  ? 'rounded-md border border-[#C04ACD] bg-[#fdf4ff] px-3 py-1.5 text-sm font-medium text-[#7E2D8E]'
                  : 'rounded-md border border-[#e5e7eb] bg-white px-3 py-1.5 text-sm text-[#475569] hover:border-[#C04ACD] hover:bg-[#fdf4ff] hover:text-[#7E2D8E]'
              }
            >
              Pick questions
            </button>
